    ...
    return (
        <div className="container-2" id="about">
            <div className="about-container">
                <h4 className="about-container__heading">About me</h4>
                <h5 className="about-container__heading2">
                    If you're interested who I am
                </h5>
                <div className="about-container__text">
                    <p className="about-container__content">
                    ...
                    <p className="about-container__content">
                        In 2019, I decided that after completing my classNamees
                        at PCC, I want to put myself into an enviornment that
                        will get my Web Development career started. That was
                        when I discovered General Assembly and decided to take
                        the Software Engineering Immersive course.
                    </p>
                    <p className="about-container__content">
                        Because best way to learn something is just to practice
                        it, I built over 5 projects during my time at GA
                        expanding my knowledge on React, Node.js and Javascript
                        in general.
                    </p>
                    <p className="about-container__content">
